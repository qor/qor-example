...
func ShowCartHandler(w http.ResponseWriter, req *http.Request) {
    ...
    config.View.Execute("/cart/cart_show", map[string]interface{}{"CurrentColorVariation": colorVariation}, req, w)
}
...
func CheckoutCartHandler(w http.ResponseWriter, req *http.Request) {
    ...
    config.View.Execute("/cart/cart_checkout", map[string]interface{}{"CurrentColorVariation": colorVariation}, req, w)
}