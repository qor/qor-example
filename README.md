...
That's almost it: If you [look at models.go](https://github.com/qor/qor-example/tree/master/app/models/models.go) you can see an `init()` function at the end: It sets up a db connection and `db.AutoMigrate(&Author{}, &Book{}, &User{})` tells QOR to automatically create the tables for our models.
...
![qor_admin](https://raw.githubusercontent.com/qor/qor-example/master/doc/screenshots/qor_admin1.png)

The menu at the top gets created by adding your models as resources to the admin in [main.go](https://github.com/qor/qor-example/blob/master/app/resources/resources.go):
...
You can see how the rest of the resources were added in [resources.go](https://github.com/qor/qor-example/blob/master/app/resources/resources.go), the `db` object referenced here is set up in [models.go](https://github.com/qor/qor-example/blob/master/app/models/models.go)
...
Look for the following line from [resources.go](https://github.com/qor/qor-example/blob/master/app/resources/resources.go)

	book.IndexAttrs("ID", "Title", "Authors", "FormattedDate", "Price")

and change `FormattedDate` to `ReleaseDate`

![qor_admin_books2](https://raw.githubusercontent.com/qor/qor-example/master/doc/screenshots/qor_admin_books2.png)
...
Then initialize `Publish` and set up AutoMigrate (see [init() in models.go](https://github.com/qor/qor-example/blob/master/app/models/models.go#L106)):
...
![qor_publish](https://raw.githubusercontent.com/qor/qor-example/master/doc/screenshots/qor_publish.png)
...
![qor_media](https://raw.githubusercontent.com/qor/qor-example/master/doc/screenshots/qor_media.png)
...
Set your default locale (In the example app these are called at the end of the `init()` function in [app/models/models.go](https://github.com/qor/qor-example/blob/master/app/models/models.go)):
...
You can find the code in [app/resources/resources.go](https://github.com/qor/qor-example/blob/master/app/resources/resources.go)

This will give you the `I18n` menu entry in admin.

Go ahead and look for the translation key `qor_admin.I18n` and translate it:

![qor_translate1](https://raw.githubusercontent.com/qor/qor-example/master/doc/screenshots/qor_translate1.png)
...
![qor_translate2](https://raw.githubusercontent.com/qor/qor-example/master/doc/screenshots/qor_translate2.png)

If you go to eg. Authors and set the locale to `ja-JP` you will see your translation appear in the admin menu on the left:

![qor_translate3](https://raw.githubusercontent.com/qor/qor-example/master/doc/screenshots/qor_translate3.png)
...
In [main.go](https://github.com/qor/qor-example/blob/master/main.go)
...
The controllers are defined in [app/controllers/controllers.go](https://github.com/qor/qor-example/blob/master/app/controllers/controllers.go):
...
`frontend.books.List of Books` will become the key that will appear in your translations resource. (after you accessed it once. See [I18n](https://github.com/qor/qor-example#i18n---translating-strings) - the NB at the end of the section if you don't know why).
...
![qor_publish2](https://raw.githubusercontent.com/qor/qor-example/master/doc/screenshots/qor_publish2.png)
